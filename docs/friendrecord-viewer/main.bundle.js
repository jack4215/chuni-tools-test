(() => {
  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    function Ar(e) {
      ...
      return t = new Hr({
        ...
        props: {
          ...
          content: Cr(((qe(e[0], 30) / 100) + (qe(e[1], 20) / 100)) * 0.2, 4)
        }
      }), {
        c() {
        ...
        p(e, n) {
          ...
          const i = {};
          16 & n && (i.title = e[4]("player.recent.average")), 1 & n && (i.content = Cr(((qe(e[0], 30) / 100) + (qe(e[1], 20) / 100)) * 0.2, 4)), s.$set(i)
        },
        i(e) {
    ...
    function Dr(e) {
      ...
      return t = new Hr({
        ...
        p(e, n) {
          ...
          const a = {};
          16 & n && (a.title = e[4]("player.recent.average")), 1 & n && (a.content = Cr(((qe(e[0], 30) / 100) + (qe(e[1], 20) / 100)) * 0.2, 4)), r.$set(a);
          const i = {};
    ...
    function Lr(e) {
      ...
      function P(e, t) {
        return "all" === e[5] ? 0 : "curr" === e[5] || "best" === e[5] ? 1 : -1
      }
      return ~($ = P(e)) && (x = L[$] = U[$](e)), {
        c() {
    ...
    function Yr(t) {
      ...
      return {
        c() {
          n = H("tr"), r = H("td"), o = A(j), s = D(), a = H("td"), i = A(S), d = D(), u = H("td"), f = A(T), N && N.c(), p = D(), _.c(), h = D(), g = H("td"), F.c(), m = D(), v = H("td"), b = A(C), y = D(), V && V.c(), w = D(), q && q.c(), O(r, "class", "song-order svelte-1gjhsjp"), O(a, "data-diff", l = t[0].difficulty), O(a, "colspan", c = 1), O(a, "class", "svelte-1gjhsjp"), O(u, "class", "svelte-1gjhsjp"), O(g, "class", "song-score svelte-1gjhsjp"), O(v, "class", "svelte-1gjhsjp"), O(n, "class", "svelte-1gjhsjp"), B(n, "best30", t[0].order <= ( "curr" === t[2] ? 20 : 30)), B(n, "best40", t[0].order <= ("best" === t[2] ? 40 : "curr" === t[2] ? 30 : 40)), B(n, "ajc", 101e4 == t[0].score);
          if (newVIndicator) {
            newVIndicator.c();
    ...
    function Bo(e) {
      ...
      return {
        ...
        p(e, t) {
          ...
          const o = {};
          512 & t && (o.playRecord = e[9]), 32 & t && (o.shown = "curr" === e[5]), p.$set(o), e[10] ? v ? 1024 & t && ge(v, 1) : (v = Wo(), v.c(), ge(v, 1), v.m(s, null)) : v && (pe(), me(v, 1, 1, (() => {
            v = null
          })), he())
        },
        i(e) {
