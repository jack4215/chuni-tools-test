(() => {
  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    function Ge(e, t, n) {
      ...
      if (r.map((e => {
          ...
          e.op = function(e) {
            ...
            let n = Math.floor(1e4 * e.const);
            let r = e.score < 1007500 ? Math.floor(e.rawRating / 100) * 100 : n + 20000 + 3 * (e.score - 1007500);
            r = e.score >= 975e3 ? 10 * Math.floor(r / 10) : 100 * Math.floor(r / 100);
            return 5 * (r + t); // 計算最終的 OP 值
        }(e),
    ...
    const et = Ue("filterGenre", Ke),
      tt = Ne("usedConstData", "luminousplus", ["luminousplus"], (() => {
      ...
      At = (() => {
        ...
        return {
          ...
          async init() {
            ...
            })), Array.prototype.push.apply(o, await gt("bestRecord", e)), r[e] = !0);
