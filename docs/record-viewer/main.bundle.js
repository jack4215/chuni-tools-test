(() => {
  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    function Yn(t) {
      let n, r, o, a, i, l, c, d, u, f, p, h, m, g, v, y;
      ...
      return {
        c() {
          ...
          g.value = "songPlayCount",
          g.textContent = "Play Count",
          v.value = "worldRank",
        ...
        p(e, [t]) {
          ...
          4096 & t && m.value !== e[12] && (m.value = e[12])
        },
        i: e,
        o: e,
        d(e) {
    ...
    function Qn(e, t, n) {
        ...
        if (!Zn(e, t)) {
          ...
          try {
            ...
            for (const [r, s] of i.slice(e - 1, t).entries())
              ...
              null == s.playCount && (
                s.playCount = await gt(m, s.difficulty, s.idx), // 根據模式切換 API 名稱
                At.set(i)
              );
      ...
      return [
        ...
        function () { m = this.value, n(12, m) } // 模式改變
      ];
    }
    ...
    function Zr(e, t, n) {
      ...
      return e.$$set = e => {
        ...
        () => {
          i || gt(m, l.difficulty, l.idx).then((e => { // 👈 用 mode 呼叫 gt
            n(0, l.playCount = e, l)
          })).catch((() => {
