    ...
    function Lr(e) {
      ...
      return ~($ = P(e)) && (x = L[$] = U[$](e)), {
        ...
        p(e, [t]) {
          ...
          const bgColor = getBackgroundColor(e[3].ratingPn);
          const hasShine = this.t.querySelector('.shine');
          if (bgColor) {
