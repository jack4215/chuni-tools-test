(() => {
  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    function mapSliderValue(input) {
      if (input <= 10) {
          return input; // 1 到 10 等比例
      } else {
          return 10 + (input - 10) * 2; // 10 到 15.5 放大比例
      }
    }
    
    function inverseMapSliderValue(output) {
        if (output <= 10) {
            return output; // 1 到 10 等比例
        } else {
            return 10 + (output - 10) / 2; // 10 到 15.5 還原比例
        }
    }
    function Hn(e) {
    ...
    function Un(t) {
      ...
      return {
        c() {
          n = H("div"), r = H("span"), o = D(), a = H("div"), i = H("div"), l = H("input"), c = D(), d = H("div"), u = H("input"), f = D(), p = H("div"), h = H("div"), g = D(), m = H("input"), v = D(), b = H("input"), l.value = inverseMapSliderValue(t[6]), O(l, "type", "number"), O(l, "min", t[3]), O(l, "max", t[4]), O(l, "step", t[5]), O(l, "inputmode", "decimal"), O(l, "class", "svelte-1aafgfe"), O(i, "class", "low svelte-1aafgfe"), z(i, "left", "calc((100% - 3rem) * " + t[9] + " / 100)"), u.value = inverseMapSliderValue(t[7]), O(u, "type", "number"), O(u, "min", t[3]), O(u, "max", t[4]), O(u, "step", t[5]), O(u, "inputmode", "decimal"), O(u, "class", "svelte-1aafgfe"), O(d, "class", "high svelte-1aafgfe"), z(d, "left", "calc((100% - 3rem) * " + t[8] + " / 100)"), O(a, "class", "indicators svelte-1aafgfe"), O(h, "class", "slider-bg svelte-1aafgfe"), z(h, "background", "linear-gradient( to right, var(--theme-border) 0%, var(--theme-border) " + (t[9] - 1) + "%, var(--theme-control) " + (t[9] - 1) + "%, var(--theme-control) " + (t[8] + 1) + "%, var(--theme-border) " + (t[8] + 1) + "%, var(--theme-border) 100% )"), O(m, "class", "low svelte-1aafgfe"), O(m, "type", "range"), O(m, "min", t[3]), O(m, "max", t[4]), O(m, "step", t[5]), O(b, "class", "high svelte-1aafgfe"), O(b, "type", "range"), O(b, "min", t[3]), O(b, "max", t[4]), O(b, "step", t[5]), O(p, "class", "slider svelte-1aafgfe"), O(n, "class", "wrapper svelte-1aafgfe")
        },
        m(e, s) {
          M(e, n, s), k(n, r), r.innerHTML = t[2], k(n, o), k(n, a), k(a, i), k(i, l), k(a, c), k(a, d), k(d, u), k(n, f), k(n, p), k(p, h), k(p, g), k(p, m), R(m, t[6]), k(p, v), k(p, b), R(b, t[7]), y || (w = [P(l, "change", t[10]), P(u, "change", t[11]), P(m, "change", t[12]), P(m, "input", (event) => {t[6] = mapSliderValue(parseFloat(event.target.value));}), P(m, "change", t[13]), P(m, "input", t[14]), P(b, "change", t[15]), P(b, "input", (event) => {t[7] = mapSliderValue(parseFloat(event.target.value));}), P(b, "change", t[16]), P(b, "input", t[17])], y = !0)
        },
        p(e, [t]) {
          4 & t && (r.innerHTML = e[2]), 64 & t && l.value !== e[6] && (l.value = e[6]), 8 & t && O(l, "min", e[3]), 16 & t && O(l, "max", e[4]), 32 & t && O(l, "step", e[5]), 512 & t && z(i, "left", "calc((100% - 3rem) * " + inverseMapSliderValue(t[9]) + " / 100)"), 128 & t && u.value !== e[7] && (u.value = e[7]), 8 & t && O(u, "min", e[3]), 16 & t && O(u, "max", e[4]), 32 & t && O(u, "step", e[5]), 256 & t && z(d, "left", "calc((100% - 3rem) * " + inverseMapSliderValue(t[8]) + " / 100)"), 768 & t && z(h, "background", "linear-gradient( to right, var(--theme-border) 0%, var(--theme-border) " + (inverseMapSliderValue(t[9]) - 1) + "%, var(--theme-control) " + (inverseMapSliderValue(t[9]) - 1) + "%, var(--theme-control) " + (inverseMapSliderValue(t[8]) + 1) + "%, var(--theme-border) " + (inverseMapSliderValue(t[8]) + 1) + "%, var(--theme-border) 100% )"), 8 & t && O(m, "min", e[3]), 16 & t && O(m, "max", e[4]), 32 & t && O(m, "step", e[5]), 64 & t && R(m, e[6]), 8 & t && O(b, "min", e[3]), 16 & t && O(b, "max", e[4]), 32 & t && O(b, "step", e[5]), 128 & t && R(b, e[7])
        },
        i: e,
        o: e,
        d(e) {
    ...
    function kr(e) {
      ...
      return void 0 !== e[8] && (Fe.value = e[8]), te = new Tn({
        ...
        i(e) {
          de || (ge(f.$$.fragment, e), ge(m.$$.fragment, e), ge(b.$$.fragment, e), ge(He), ge(T.$$.fragment, e), ge(L.$$.fragment, e), ge(Pe), ge(F.$$.fragment, e), ge(q.$$.fragment, e), ge(Z.$$.fragment, e), ge(te.$$.fragment, e), re((() => {
            de && (ce || (ce = be(t, $n, {
              duration: 100
            }, !0)), ce.run(1))
          })), de = !0)
        ...
        o(e) {
          me(f.$$.fragment, e), me(m.$$.fragment, e), me(b.$$.fragment, e), me(He), me(T.$$.fragment, e), me(L.$$.fragment, e), me(Pe), me(F.$$.fragment, e), me(q.$$.fragment, e), me(Z.$$.fragment, e), me(te.$$.fragment, e), ce || (ce = be(t, $n, {
            duration: 100
          }, !1)), ce.run(0), de = !1
        },
        d(e) {
          e && E(t), ke(f), ke(m), ke(b), He && He.d(), ke(T), ke(L), Pe && Pe.d(), ke(F), ke(q), ke(Z), ke(te), e && ce && ce.end(), ue = !1, s(fe)
        }
      }
    }
    ...
    function Ar(e) {
      ...
      return t = new Hr({
        ...
        props: {
          title: e[4]("player.recent.new10"),
          content: Cr(qe(e[1], 10) / 100, 4)
        }
      }), s = new Hr({
        props: {
          title: e[4]("player.recent.average"),
          content: Cr((qe(e[0], 30) / 100) * 0.75 + (qe(e[1], 10) / 100) * 0.25, 4)
        }
      }), {
        c() {
        ...
        p(e, n) {
          const o = {};
          16 & n && (o.title = e[4]("player.best.best30")), 2 & n && (o.content = Cr(qe(e[0], 30) / 100, 4)), t.$set(o);
          const a = {};
