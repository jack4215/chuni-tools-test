(() => {
  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    function Yr(t) {
      let n, r, o, s, a, i, l, c, d, u, f, p, h, g, m, v, b, y, w, $, x;
      let j = t[0].order + "",
          S = t[0].title + "",
          T = (t[0].const < 0 ? "-" : t[0].const?.toFixed(1) ?? "??.?") + "",
          C = (t[0].const < 0 || t[0].score === -1 ? "-" : t[0].rating == null ? "??.??" : (t[0].rating / 100).toFixed(2)) + "",
          N = t[0].constUncertain && Ir();
      let newVIndicator = t[0].newV && Zs();
    
      // 動態設置顏色
      function applyColorCondition(element, newV, difficulty) {
        if (newV === 1) {
          z(element, "color", "pink"); // 設置為粉紅色
        } else if (newV === 2 && difficulty === "ULT") {
          z(element, "color", "pink"); // 設置為粉紅色
        } else {
          z(element, "color", ""); // 清除顏色
        }
      }
      ...
      return {
        c() {
          ...
          // 初始化顏色
          applyColorCondition(u, t[0].newV, t[0].difficulty);
        ...
        p(e, [t]) {
          ...
          if (1 & t && l !== (l = e[0].difficulty)) {
            O(a, "data-diff", l);
          }
          if (1 & t) {
            T = (e[0].const < 0 ? "-" : e[0].const?.toFixed(1) ?? "??.?") + "";
            I(f, T);
          }
    
          // 更新顏色
          applyColorCondition(u, e[0].newV, e[0].difficulty);
        },
        i: e,
        o: e,
        d(e) {
