 ...
 //     console.log(t);
  ...
  //    console.log(t);
    ...
    function Yo(e, t, n) {
      ...
      e.$$.update = () => {
        507908 & e.$$.dirty && n(0, r = h.filter((e => ("hide" != f || e.score >= 0) && (!(f === "dgvalue" || f === "dgpercentage") || (e.dg === 1 || e.dg === 2)) && d[e.difficulty] && c[Ie.find((t => _e[t] == e.genre))] && j[Rl.find((e => _s[e] == e.release))] && l >= e.const && e.const >= i))), console.log(r), 1 & e.$$.dirty && n(4, o = (() => {
          let e = {};
