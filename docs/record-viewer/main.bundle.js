    ...
    function Un(t) {
      ...
      return {
          ...
          p(e, [t]) {
              ...
              // 更新 low 和 high 的位置
              if (512 & t) {
                  z(i, "left", `calc((100% - 3rem) * ${e[9]} / 100)`);
              }
              if (256 & t) {
                  z(d, "left", `calc((100% - 3rem) * ${e[8]} / 100)`);
              }
  
              // 更新背景顏色
              768 & t && z(h, "background", `linear-gradient( to right, var(--theme-border) 0%, var(--theme-border) ${e[9] - 1}%, var(--theme-control) ${e[9] - 1}%, var(--theme-control) ${e[8] + 1}%, var(--theme-border) ${e[8] + 1}%, var(--theme-border) 100% )`);
